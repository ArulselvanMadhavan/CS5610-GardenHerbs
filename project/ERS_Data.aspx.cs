...
public partial class project_ERS_Data : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string _rootArmsUrl = "http://api.data.gov/USDA/ERS/data/Arms/";
            string _myKey = "yUuLtcWhYIWo59buKRXhTY5jOGrKXb5FgDUMwTFF";
            ...
            string _year = _years.FirstOrDefault(y => y == "2010").ToString();
