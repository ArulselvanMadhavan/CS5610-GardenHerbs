<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home-test.aspx.cs" Inherits="project_Home" %>
...
<head runat="server">
    ...
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        ...
        <script src="js/homepage/skel.min.js"></script>
		<script src="js/homepage/skel-layers.min.js"></script>
...
<body class="homepage">
    <form id="form1" runat="server">
        ...
        <a href="searchCrops.aspx">SearchCrops</a>
		<!-- Header -->
			<header id="header">
