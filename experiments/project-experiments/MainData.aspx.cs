...
public partial class project_MainData : System.Web.UI.Page
{
    ...
    {
        //string w_key = .GetKey(this, "quickstats");
    ...
    public void ProcessResponse(XmlDocument locationsResponse)
    {
        ...
        string UrlRequest = "http://quickstats.nass.usda.gov/api/api_GET/?key="
            + "9479ED1A-C12B-36E2-B3DD-3C4859C87441&source_desc=CENSUS&sector_desc=CROPS&statisticcat_desc=PRODUCTION&year__GE=2012&state_alpha=MA&format=XML";
